...
SECRET_KEY = 'django-insecure-!s(rmaa)jj3lnk#bj=q3h3sx*%rlpr63)$-%t(g8z1&4en$n%p'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:5173",
    "http://localhost:3000",
    "http://193.233.201.124:5174",
    "http://193.233.201.124:5173",
    "http://193.233.201.124:3000",
]
...
REST_FRAMEWORK = {
    ...
    # Если хочешь, чтобы по умолчанию все эндпоинты были закрыты, раскомментируй строки ниже:
